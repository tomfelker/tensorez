# based on https://github.com/kevinzakka/spatial-transformer-network
# (MIT license, by Kevin Zakka, based on 
# but with some fixes (todo: submit these)
# - change an off-by-one so the identity transform is pixel-perfect
# - change clamping so it's not just black (hmm, why was it black? - or was it negative?)
# Tom Felker

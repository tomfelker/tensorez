...
file_glob = os.path.join('data', '2022-12-07_moon_mars_conjunction', '2022-12-08-0824_3-CapObj.SER'); #crop = (1024, 1024); file_glob_darks = os.path.join('data', '2022-12-07_moon_mars_conjunction', '2022-12-08-0827_3-CapObj.SER')
...
for filename in glob.glob(file_glob):
    for image_hwc, frame_index in ImageSequenceReader(filename, skip = light_frame_skip, to_float = True, demosaic = True):           
        ...
        print(f"finished pass 1 step {image_count}")
